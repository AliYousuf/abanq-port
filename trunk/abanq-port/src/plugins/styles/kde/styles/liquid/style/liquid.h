...
public:
    ...
    ~OptionHandler() {
        if (fillPixmap)delete fillPixmap;
    }
    void reloadSettings();
    int transType() {
        return(type);
    }
    KPixmap *pixmap(long id) {
        return(pixDict.find(id));
    }
    QPixmap* bgPixmap() {
        return(fillPixmap);
    }
    ...
    bool usePanelStipple() {
        return(panelStipple);
    }
    int stippleContrast() {
        return(contrast);
    }
    bool useReverseBtnColor() {
        return(reverseBtnColor);
    }
    bool usePanelCustomColor() {
        return(panelCustom);
    }
    bool useanimateProgressBar() {
        return(animateProgressBar);
    }
    QColor panelCustomColor() {
        return(customPanelColor);
    }
    bool useToolButtonFrame() {
        return(tbFrame);
    }
    void prepareMenus();
    ...
    const QColor& customColor(int idx) {
