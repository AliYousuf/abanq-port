...
@author InfoSiAL S.L.
*/
class FL_EXPORT FLApplicationInterface : public QObject {
...
public slots:
...
#ifdef FL_TEST
    obj_->startTest( codSessionCat, idFuncional, bd );
#endif
  }
...
#ifdef FL_TEST
    return obj_->testSessionsList( bd );
#endif
  }
  ...
  */
  QString diskCacheAbsDirPath() {
    return FLDiskCache::absoluteDirPath();
  }
  ...
  */
  QString * nameObjectScript( const QString & nFS ) {
    return obj_->nameObjectScript( nFS );
  }
  ...
  */
  ...
  /**
  Intenta continuar el script de pruebas llamando a la función tryContinue una vez terminada la ejecución de las funciones de script

  @param fName Nombre de la función.
  */
  void continueTesting( const QString &fName ) {
#ifdef FL_TEST
    obj_->continueTesting( FLTester::SCRIPT_FINISHED, fName );
#endif
  }
  ...
  */
  const QString & nameDriver( const QString & connName = "default" ) const {
  ...
  */
  const QString & nameUser( const QString & connName = "default" ) const {
  ...
  */
  const QString & nameBD( const QString & connName = "default" ) const {
  ...
  */
  const QString & nameHost( const QString & connName = "default" ) const {
  ...
  */
  QString idSession( ) {
    return static_cast<FLApplication *>( qApp ) ->timeUser().toString( Qt::ISODate );
  }
  ...
  */
  QString connectionNameForAction( const QString & actionName = QString::null ) {
    return static_cast<FLApplication *>( qApp )->connectionNameForAction( actionName );
  }
  ...
  */
  void setReimpMethod( const QString & method, const QString & scrFunction ) {
    static_cast<FLApplication *>( qApp )->setReimpMethod( method, scrFunction );
  }
  ...
  */
  bool existsReimpMethod( const QString & method ) const {
    return static_cast<FLApplication *>( qApp )->existsReimpMethod( method );
  }
  ...
  */
  QSArgument callReimp( const QString & method, const QSArgumentList & arguments = QSArgumentList() ) {
    return static_cast<FLApplication *>( qApp )->callReimp( method, arguments );
  }
...
@author InfoSiAL S.L.
*/
class FL_EXPORT FLSqlCursorInterface : public QObject {
...
public:
  ...
  Constructor
  */
  FLSqlCursorInterface( const QString & n = QString::null, const QString & connName = "default" ) : QObject( 0 ), obj_( 0 ), cursorRelation_( 0 ) {
    if ( !n.isEmpty() ) {
  ...
  Constructor
  */
  FLSqlCursorInterface( QObject * obj ) : QObject( obj ), obj_( 0 ), cursorRelation_( 0 ) {
    setObj( static_cast<FLSqlCursor *>( obj ) );
  }
  ...
  */
  void editRecord() {
    if ( obj_ ) {
      ...
      obj_->editRecord();
#ifdef FL_TEST
      QString formName = "formRecord" + obj_->action() ->name();
      static_cast<FLApplication *>( qApp ) ->continueTesting( FLTester::FORM_RECORD_READY, formName );
#endif
    }
  }
...
@author InfoSiAL S.L.
*/
class FL_EXPORT FLSqlQueryInterface : public QObject {
...
public slots:
  ...
  */
  const QVariant &valueParam( const QString &name ) const {
  ...
  */
  ...
  /**
  Obtiene la sentencia completa SQL de la consulta.
...
@author InfoSiAL S.L.
*/
class FL_EXPORT FLFieldDBInterface : public QObject {
...
public:
  ...
  Constructor
  */
  FLFieldDBInterface( QWidget *p, const char *n ) : QObject( p ) {
...
public:
  ...
  Constructor
  */
  FLTableDBInterface( QWidget *p, const char *n ) : QObject( p ) {
...
@author InfoSiAL S.L.
*/
#define NEW_TABLE if ( !obj_ ) { obj_ = new QTable( qApp->mainWidget() ); connects(); }

class FL_EXPORT FLTableInterface : public QObject {
...
public:
  ...
  Constructor
  */
  FLTableInterface( QWidget *p, const char *n ) : QObject( p ) {
    obj_ = new QTable( p, n );
    if ( obj_ )
      connects();
  }
...
class FL_EXPORT FLListViewItem: public QListViewItem {
public:
...
class FL_EXPORT FLListViewInterface : public QObject {
...
public:
  ...
  Constructor
  */
  FLListViewInterface( QWidget *p, const char *n ) : QObject( p ) {
...
@author InfoSiAL S.L.
*/
class FL_EXPORT FLListViewItemInterface : public QObject {
...
//     void emitCurremtChanged( int row, int col ) {
//         emit currentChanged( row, col );
//     }
...
@author InfoSiAL S.L.
*/
class FL_EXPORT FLTabWidgetInterface : public QObject {
...
public slots:
  ...
  */
  void setTabEnabled( const int index, const bool enable ) {
    QWidget * w = obj_->page( index );
  ...
  @param enable Si es TRUE el tab se mostrará habilitado, si es FALSE se pondrá inhabilitado
  */
  void setTabEnabled( const QString & name, const bool enable );
...
@author InfoSiAL S.L.
*/
class FL_EXPORT FLFormDBInterface : public QObject {
...
public:
  ...
  */
  FLFormDBInterface( const QString &a, QWidget *p, WFlags f = 0 )
    ...
    setObj( new FLFormDB( a, static_cast<FLApplication *>( qApp )->mainWidget(), f ) );
  }
  ...
  */
  FLFormDBInterface( FLSqlCursorInterface * c, const QString &a, QWidget *p, WFlags f = 0 )
      : QObject( p ), obj_( 0 ), cursor_( 0 ), script_( 0 ) {
    setObj( new FLFormDB( c->obj(), a, static_cast<FLApplication *>( qApp )->mainWidget(), f ) );
  }
...
@author InfoSiAL S.L.
*/
class FL_EXPORT FLFormRecordDBInterface : public QObject {
...
public:
  ...
  */
  FLFormRecordDBInterface( FLSqlCursorInterface *c, const QString &a, QWidget *p, bool sA ) : QObject( p ), obj_( 0 ),
      cursor_( 0 ), script_( 0 ), childrenIface( 0 ) {
    setObj( new FLFormRecordDB( c->obj(), a, static_cast<FLApplication *>( qApp )->mainWidget(), sA ) );
  }

  /**
  Constructor
  */
  FLFormRecordDBInterface( FLFormRecordDB *obj ) : QObject( obj ), obj_( 0 ), cursor_( 0 ), script_( 0 ), childrenIface( 0 ) {
    setObj( obj );
  }
  ...
  Constructor
  */
  FLFormRecordDBInterface() : QObject( 0 ), obj_( 0 ), cursor_( 0 ), script_( 0 ), childrenIface( 0 ) {}
...
public slots:
  ...
  */
  void setMainWidget( const QString & uiFileName ) {
    if ( obj_ )
      static_cast<FLFormDB *>( obj_ )->setMainWidget( uiFileName );
  }
...
private:
  ...
  FLSqlCursorInterface * cursor_;
  QSScript * script_;
  QPtrDict<QObject>  * childrenIface;
};
...
@author InfoSiAL S.L.
*/
class FL_EXPORT FLFormSearchDBInterface : public QObject {
...
public:
  ...
  */
  ...
  Constructor
  */
  FLFormSearchDBInterface() : QObject( 0 ), obj_( 0 ), cursor_( 0 ), script_( 0 ), childrenIface( 0 ) {
  }
...
@author InfoSiAL S.L.
*/
class FL_EXPORT FLVarInterface : public QObject {
...
@author InfoSiAL S.L.
*/
class FL_EXPORT FLUtilInterface : public QObject {
...
public slots:
  ...
  */
  ...
  /**
  Lee el valor de un setting en el directorio de la instalación de FacturaLUX
  ...
  */
  ...
  /**
  Establece el valor de un setting en el directorio de instalación de FacturaLUX
  ...
  */
  ...
  con las soportadas por FacturaLUX.
  ...
  */
  ...
  @param connName Nombre de la conexion
  */
  QString fieldNameToAlias( const QString & fN, const QString & tN, const QString & connName = "default" );
  ...
  @param connName Nombre de la conexion
  */
  QString tableNameToAlias( const QString & tN, const QString & connName = "default" );
  ...
  @param connName Nombre de la conexion
  */
  QString fieldAliasToName( const QString & aN, const QString & tN, const QString & connName = "default" );
  ...
  @param connName Nombre de la conexion
  */
  int fieldType( const QString & fN, const QString & tN, const QString & connName = "default" );
  ...
  @param connName Nombre de la conexion
  */
  int fieldLength( const QString & fN, const QString & tN, const QString & connName = "default" );
  ...
  @param connName Nombre de la conexion
  */
  bool fieldAllowNull( const QString & fN, const QString & tN, const QString & connName = "default" );
  ...
  */
  int daysTo( const QString & d1, const QString & d2 ) {
    return FLUtil::daysTo( QDate::fromString( d1, Qt::ISODate ), QDate::fromString( d2, Qt::ISODate ) );
  }
...
@author InfoSiAL S.L.
*/
class FL_EXPORT FLCodBarInterface : public QObject {
...
@author InfoSiAL S.L.
*/
class FL_EXPORT FLScriptEditorInterface : public QObject {
...
@author InfoSiAL S.L.
*/
class FL_EXPORT FLDomNodeListInterface : public QObject {
...
@author InfoSiAL S.L.
*/
class FL_EXPORT FLDomNodeInterface : public QObject {
...
//! Visor de informes
/**
Muestra el informe basado en una consulta sql (definida en un fichero .qry)
y una plantilla de informe (definida en un fichero .kut)

@author InfoSiAL S.L.
*/
class FL_EXPORT FLReportViewerInterface : public QObject {
...
public:
  ...
  */
  FLReportViewerInterface() : QObject( 0 ), obj_( 0 ) {
    obj_ = new FLReportViewer( static_cast<FLApplication *>( qApp )->mainWidget() );
  }
...
public slots:
  ...
  */
  bool renderReport( const int initRow = 0, const int initCol = 0 ) {
    return obj_->renderReport( initRow, initCol );
  }
  ...
  */
  ...
  /**
  Obtiene los datos del informe en formato csv (una vez hecho el render)
  */
  QString csvData() {
    return obj_->csvData();
  }
...
@author InfoSiAL S.L.
*/
class FL_EXPORT FLProcessInterface : public QProcess {
...
class FL_EXPORT FLPosPrinterInterface : public QObject {
...
@author InfoSiAL S.L.
*/
class FL_EXPORT FLObjectFactory : public QSObjectFactory {
...
@author InfoSiAL, S.L.
*/
class FL_EXPORT FLSmtpClientInterface : public QObject {
...
class FL_EXPORT FLImageViewerInterface : public QObject {
...
class FL_EXPORT FLSerialPortInterface : public QObject {
