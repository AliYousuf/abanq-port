...
@author InfoSiAL S.L., Eloy Orduña Gonález, Andrés Otón Urbano
*/
class FL_EXPORT FLUtil {
...
public:
  ...
  */
  ...
  /**
  Decodifica un tipo de FacturaLUX a un tipo QVariant

  @param fltype Tipo de datos de FacturaLUX.
