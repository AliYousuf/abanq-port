...
function oficial_enviarBixolon():String
{
...
function oficial_insertarLineaClicked()
{
	...
	fis.openPort(port);
	MessageBox.information(util.translate("scripts",  this.iface.enviarBixolon() ),MessageBox.Ok,MessageBox.NoButton);
