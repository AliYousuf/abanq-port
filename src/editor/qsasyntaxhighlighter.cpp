...
{
    if ( s == qApp->tr( QString::fromLatin1("Standard") ) )
	return QSASyntaxHighlighter::Standard;
    if ( s == qApp->tr( QString::fromLatin1("Comment") ) )
	return QSASyntaxHighlighter::Comment;
    if ( s == qApp->tr( QString::fromLatin1("Number") ) )
	return QSASyntaxHighlighter::Number;
    if ( s == qApp->tr( QString::fromLatin1("String") ) )
	return QSASyntaxHighlighter::String;
    if ( s == qApp->tr( QString::fromLatin1("Type") ) )
	return QSASyntaxHighlighter::Type;
    if ( s == qApp->tr( QString::fromLatin1("Label") ) )
	return QSASyntaxHighlighter::Label;
    if ( s == qApp->tr( QString::fromLatin1("Keyword") ) )
	return QSASyntaxHighlighter::Keyword;
    if ( s == qApp->tr( QString::fromLatin1("Preprocessor") ) )
