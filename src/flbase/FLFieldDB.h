...
@author InfoSiAL S.L.
*/
class FL_EXPORT FLFieldDB: public FLWidgetFieldDB {
...
class FL_EXPORT FLPixmapView: public QScrollView, public QFilePreview {
...
class FL_EXPORT FLLineEdit: public QLineEdit {
...
// Uso interno
class FL_EXPORT FLDoubleValidator: public QDoubleValidator {
...
// Uso interno
class FL_EXPORT FLIntValidator: public QIntValidator {
...
// Uso interno
class FL_EXPORT FLUIntValidator: public QIntValidator {
...
// Uso interno
class FL_EXPORT FLSpinBox: public QSpinBox {
...
// Uso interno
class FL_EXPORT FLDateEdit: public QDateEdit {
