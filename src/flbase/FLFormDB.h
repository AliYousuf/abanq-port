...
@author InfoSiAL S.L.
*/
class FL_EXPORT FLFormDB: public QWidget {
...
public slots:
  ...
  */
  ...
  /**
  Abrir IDE en el contexto de este formulario
  */
  void openIde();
...
#ifdef FL_DEBUGGER
  /**
  Para abrir IDE en el contexto de este formulario
  */
  QPushButton *pushButtonIDE;
#endif
