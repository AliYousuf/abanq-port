...
// #endif
    ...
    case PM_DefaultFrameWidth:
        if (widget && (widget->isTopLevel() || !widget->parentWidget() || (::qt_cast<QMainWindow*>(widget->parentWidget()) && ((QMainWindow*)widget->parentWidget())->centralWidget() == widget)) && (::qt_cast<QScrollView*>(widget) || widget->inherits("QWorkspaceChild")))
            return 0;
#else
    case PM_DefaultFrameWidth: {
                             ...
                             QStyleHintReturn* returnData ) const
{
    ...
    case SH_ScrollView_FrameOnlyAroundContents:
        if (widget && (widget->isTopLevel() || !widget->parentWidget() || widget->parentWidget()->isTopLevel()) && (::qt_cast<QScrollView*>(widget) || widget->inherits("QWorkspaceChild")))
            return TRUE;
