...
protected:
  ...
  */
  void drawDetailFooter( MPageCollection * pages, int level,
                         QPtrList < QMemArray < double > >*gDT = 0, QValueVector < QString > *gDTS = 0 );

  /**
  Draws the detail add-on header to the level
  */
  void drawAddOnHeader( MPageCollection * pages, int level,
                        QPtrList < QMemArray < double > >*gDT, QValueVector < QString > *gDTS = 0 );
  ...
  */
  bool canDrawDetailHeader( const uint &level, const uint &currRecord, const uint &yPos );

  /**
  Decides whether the current detail fits in the current page or not
  */
  bool canDrawDetail( const uint &level, const uint &currRecord, const uint &yPos );
  ...
  */
  void setFieldValues( QDomNamedNodeMap *fields, int level, MReportSection *detail );
