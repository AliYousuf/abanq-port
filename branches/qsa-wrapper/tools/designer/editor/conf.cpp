...
QMap<QString, ConfigStyle> Config::defaultStyles()
{
    ...
    s.color = Qt::black;
    styles.insert( qApp->tr( QString::fromLatin1("Standard") ), s );

    s.font = QFont( commentFamily, normalSize, normalWeight, true );
    s.color = Qt::darkGray;
    styles.insert( qApp->tr( QString::fromLatin1("Comment") ), s );

    s.font = QFont( normalFamily, normalSize, normalWeight );
    s.color = Qt::blue;
    styles.insert( qApp->tr( QString::fromLatin1("Number") ), s );

    s.font = QFont( normalFamily, normalSize, normalWeight );
    s.color = Qt::red;
    styles.insert( qApp->tr( QString::fromLatin1("String") ), s );

    s.font = QFont( normalFamily, normalSize, normalWeight );
    s.color = Qt::darkMagenta;
    styles.insert( qApp->tr( QString::fromLatin1("Type") ), s );

    s.font = QFont( normalFamily, normalSize, QFont::Bold );
    s.color = Qt::black;
    styles.insert( qApp->tr( QString::fromLatin1("Keyword") ), s );

    s.font = QFont( normalFamily, normalSize, normalWeight );
    s.color = Qt::darkBlue;
    styles.insert( qApp->tr( QString::fromLatin1("Preprocessor") ), s );

    s.font = QFont( normalFamily, normalSize, normalWeight );
    s.color = Qt::black;
    styles.insert( qApp->tr( QString::fromLatin1("Label") ), s );
...
QMap<QString, ConfigStyle> Config::readStyles( const QString &path )
{
	...
	qApp->tr( QString::fromLatin1("Number") ),
	qApp->tr( QString::fromLatin1("String") ),
	qApp->tr( QString::fromLatin1("Type") ),
	qApp->tr( QString::fromLatin1("Keyword") ),
	qApp->tr( QString::fromLatin1("Preprocessor") ),
	qApp->tr( QString::fromLatin1("Label") ),
	qApp->tr( QString::fromLatin1("Standard") ),
	QString::null
    };
